...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, readBody, sendStream, getQuery as getQuery$1, createError, getResponseStatusText } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/h3/dist/index.mjs';
import { GoogleGenerativeAI } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/@google/generative-ai/dist/index.mjs';
import { Readable } from 'stream';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/devalue/index.js';
import { renderToString } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/vue/server-renderer/index.mjs';
import { renderSSRHead } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/ofetch/dist/node.mjs';
import destr from 'file:///Users/paco/Desktop/gemini-chat/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/scule/dist/index.mjs';
import { klona } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/defu/dist/defu.mjs';
import { hash } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/ufo/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/paco/Desktop/gemini-chat/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/radix3/dist/index.mjs';
import { version, unref } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/paco/Desktop/gemini-chat/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/paco/Desktop/gemini-chat/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/paco/Desktop/gemini-chat","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/paco/Desktop/gemini-chat/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/paco/Desktop/gemini-chat/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/paco/Desktop/gemini-chat/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/paco/Desktop/gemini-chat/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _ZFCkNthK0q = (function(nitro) {
...
const _lazy_VbFHxk = () => Promise.resolve().then(function () { return ask$1; });
const _lazy_7hX37s = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/ask', handler: _lazy_VbFHxk, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_7hX37s, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_7hX37s, lazy: true, middleware: false, method: undefined }
];
...
const ask = defineEventHandler(async (event) => {
...
const getClientManifest = () => import('file:///Users/paco/Desktop/gemini-chat/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/paco/Desktop/gemini-chat/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
